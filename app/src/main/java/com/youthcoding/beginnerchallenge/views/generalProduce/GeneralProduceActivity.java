package com.youthcoding.beginnerchallenge.views.generalProduce;
 ...
 */
public class GeneralProduceActivity extends AppCompatActivity implements UserLocationFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_produce);
